...
- Senden Sie die Commits, die Sie bisher erstellt haben, zum Remote-Repositorium (-> Push).  
Achten Sie darauf, dass Sie tatsächlich im richtigen Branch (*Workshop*) gearbeitet haben und diesen auch zum Remote schicken. 
Holen Sie die Änderungen der anderen vom Remote-Repositorium in ihr lokales Repositorium (-> Pull).
...
### **Git-Lösungen**
- Zentrale Versionskontrolle verhindert Dateidoubletten  
- Commit-Historie zeigt klar, wer was wann geändert hat  
- Branches ermöglichen paralleles Arbeiten ohne Überschreiben  
- GitHub als Backup schützt vor Verlust  
- Vollständige Historie macht Arbeit transparent  
- Pull Requests ermöglichen strukturierte Betreuung und Feedback  
...
<table>
  ...
  <tr class="fragment">
    <td><strong>Konflikte in Gruppenarbeiten</strong></td>
    <td>Branches ermöglichen paralleles Arbeiten ohne Überschreiben</td>
  </tr>
  <tr class="fragment">
    <td><strong>Datenverlust</strong></td>
    <td>GitHub dient als zuverlässiges Online-Backup</td>
  </tr>
  <tr class="fragment">
  ...
  <tr class="fragment">
    ...
    <td>Pull Requests erleichtern Feedback, Review & Fortschrittskontrolle</td>
  </tr>
</table>
...
## Fazit
**Git schafft Ordnung, Transparenz und zuverlässige Zusammenarbeit – ideal für Lehre und Abschlussarbeiten.**
