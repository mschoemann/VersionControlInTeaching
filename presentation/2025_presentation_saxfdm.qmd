...
-   Erstellen Sie eine aussagekräftige `README.md`-Datei.
-   Klonen Sie das Repositorium in einen lokalen Ordner Ihrer Wahl.
-   Fügen Sie in das Repositorium Lehrmaterialien, etc. ein.  
Probieren Sie dabei grundlegende Funktionen von Git aus, die Sie heute kennen gelernt haben (z.B. Commit, Push, Pull, etc.)
